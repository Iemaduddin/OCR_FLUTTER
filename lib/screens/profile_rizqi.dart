...
import 'package:image_picker_flutter/widgets/photo-album.dart';
...
class ProfileRizqi extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        drawer: NowDrawer(currentPage: "Profile Rizqi"),
        body: Stack(
          children: <Widget>[
            Column(
              children: [
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                children: [
                                  CircleAvatar(
                                      backgroundImage:
                                          AssetImage("assets/imgs/rizqi.jpg"),
                                      radius: 65.0),
                                  Padding(
                                    padding: const EdgeInsets.only(top: 24.0),
                                    child: Text("Rizqi Rohmatul Huda",
                                        style: TextStyle(
