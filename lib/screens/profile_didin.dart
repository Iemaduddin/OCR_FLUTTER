...
class ProfileDidin extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        drawer: NowDrawer(currentPage: "Profile Didin"),
        body: Stack(
          children: <Widget>[
            Column(
              children: [
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                children: [
                                  CircleAvatar(
                                      backgroundImage:
                                          AssetImage("assets/imgs/didin.jpg"),
                                      radius: 65.0),
                                  Padding(
                                    padding: const EdgeInsets.only(top: 24.0),
                                    child: Text("Iemaduddin",
                                        style: TextStyle(
