...
class ProfileAldi extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        drawer: NowDrawer(currentPage: "Profile Aldi"),
        body: Stack(
          children: <Widget>[
            Column(
              children: [
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                children: [
                                  CircleAvatar(
                                      backgroundImage:
                                          AssetImage("assets/imgs/aldi.jpg"),
                                      radius: 65.0),
                                  Padding(
                                    padding: const EdgeInsets.only(top: 24.0),
                                    child: Text("Arainal Aldiansyah",
                                        style: TextStyle(
